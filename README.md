...
* Start with [PSVR webcam 6DoF: SteamVR first run](misc/PSVR_STEAMVR_FIRST_RUN.md)
  when testing a matching custom Win64 LED-tracking package.
...
* See [Windows trial builds](misc/WINDOWS_TRIAL_BUILD.md) for the reproducible
  Win64 workflow, package contents, and download verification.
