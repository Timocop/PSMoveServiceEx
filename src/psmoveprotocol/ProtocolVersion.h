...
#define PSM_RELEASE_VERSION_MINOR		23
#define PSM_RELEASE_VERSION_BUILD		6
#define PSM_RELEASE_VERSION_REVISION	0

/// "Product.Major-Phase Minor.Release.Hotfix"
#if !defined(PSM_RELEASE_VERSION_STRING)
    #define PSM_RELEASE_VERSION_STRING PSM_STRINGIZE(PSM_RELEASE_VERSION_MAJOR.PSM_RELEASE_VERSION_MINOR.PSM_RELEASE_VERSION_BUILD.PSM_RELEASE_VERSION_REVISION)
#endif
