...
void AppStage_TrackerSettings::renderUI()
{
			...
			if (m_trackerInfos.size() > 0)
			{
...

				{
					...
					ImGui::BeginGroup();
					{
						...
						{
							if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconTracker(), "Test Video Feed") || m_gotoVideoTest)
							{
								m_gotoVideoTest = false;
							...
							if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconTarget(), "Calibrate Tracker Distortion"))
							{
								m_app->setAppStage(AppStage_DistortionCalibration::APP_STAGE_NAME);
							}

							if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconClose(), "Reset Tracker Pose"))
							{
						...
						{
							AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconClose(), "Test Video Feed (Unavailable)");
							AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconClose(), "Calibrate Tracker Distortion (Unavailable)");
						}
					}
					ImGui::EndGroup();
...

							{
									...
									m_gotoControllerColorCalib)
								{
									...
									ImGui::BeginGroup();
									{
										if (m_app->getIsLocalServer())
										{
											if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconTarget(), "Calibrate Tracking Colors##Controller") ||
												m_gotoControllerColorCalib)
											{
												m_gotoControllerColorCalib = false;
											...
											if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconTarget(), "Calibrate Tracker Poses##Controller"))
											{
										...
										{
											AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconClose(), "Calibrate Tracking Colors (Unavailable)");
											AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconClose(), "Calibrate Tracker Poses (Unavailable)");
										}
									}
									ImGui::EndGroup();
									if (ImGui::IsItemVisible())
									...
									m_gotoTrackingControllerVideo || m_gotoTestControllerTracking || m_gotoTrackingVideoALL)
								{
									...
									ImGui::BeginGroup();
									{
										if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconSearch(), "Test Tracking Colors##Controller") || m_gotoTrackingControllerVideo)
										{
											m_gotoTrackingControllerVideo = false;
										...
										if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconSearch(), "Test Tracking Pose##Controller") ||
						...
						if (m_hmdInfos.size() > 0)
						{
								...
								m_gotoHMDColorCalib)
							{
								...
								ImGui::BeginGroup();
								{
									if (m_app->getIsLocalServer())
									{
										if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconTarget(), "Calibrate Tracking Colors##HMD") ||
											m_gotoHMDColorCalib)
										{
											m_gotoHMDColorCalib = false;
										...
										if (m_selectedHmdIndex != -1)
										{
											...
											{
												if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconTarget(), "Calibrate Tracker Poses##HMD"))
												{
								...
								m_gotoTestHmdTracking || m_gotoTrackingHmdVideo || m_gotoTrackingVideoALL)
							{
								...
								ImGui::BeginGroup();
								{
									if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconSearch(), "Test Tracking Colors##HMD") ||
									...
									if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconSearch(), "Test Tracking Pose##HMD") ||
	...
	case eTrackerMenuState::trackerResetPoseWarning:
	{
		...
		ImGui::Separator();
		if (AssetManager::ImGuiButtonIcon(AssetManager::getInstance()->getIconUpdate(), "Reset Pose"))
		{
